...
function popupOpen(e) {
  ...
  if($videoPopup.length) {
    var $videodata = $(".js-video-data"),
        $iframedata = $(".js-video-src"),
        videosrc = $videodata.data("youtube-src");
...
$(function () {
  ...
  // scroll btn : s
  var $mainboardBtn = $('.js-btn-scroll-main');
  $mainboardBtn.on("click", function(e){
    e.preventDefault();
    var targetOffset = $(".main-board").outerHeight();
  ...
  var $snsCloseBtn = $(".js-close-sns");
  $snsCloseBtn.on("click", function(e){
    e.preventDefault();
    $(this).parent(".sns-link").parent(".sns-share__item").removeClass("is-selected");
  });
