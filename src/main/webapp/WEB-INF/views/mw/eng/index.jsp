...
<body class="main-type">
  ...
  <div class="gnb-container">
      <div class="gnb-header">
        <h1 class="gnb-header__symbol"><a href="/index" class="gnb-header__symbol-anchor"><img src="/mw/eng/assets/img/ico-logo.png" alt="SOME SING" class="gnb-header__symbol-img"></a></h1>
        <h1 class="gnb-header__util"><a href="/index"></a></h1>
      </div>
      <!-- gnb-header//end -->
      <div class="gnb-box">
        <div class="gnb-menu">
                ...
                <li class="gnb-util__item" role="menuitem">
                  ...
                  <div class="gnb-util__language">
                    <ul class="gnb-util__language-itembox">
                      <li class="gnb-util__language-item"><a href="?lang=kor" class="gnb-util__language-anchor">한국어</a></li>
                      <li class="gnb-util__language-item"><a href="?lang=en" class="gnb-util__language-anchor is-selected">ENGLISH</a></li><!-- 현재 언어 페이지 일때 is-selected class 추가 -->
                    </ul>
                  </div>
                </li>
              </ul>
      ...
      <section class="content-container">
        ...
        <article class="main-board js-scroll-item">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                  <div class="main-board__text">
                    <strong class="main-board__text-title">Freedom of Time! Freedom of Location! You can sing and Listen with no limits.</strong>
                  ...
                  <div class="main-board__image"><img src="/mw/eng/assets/img/img-main-board1.jpg" alt="" class="main-board__image-bg"></div>
              </div>
              <!-- swiper-slide//end -->
              <div class="swiper-slide">
                <div class="main-board__text">
                  <strong class="main-board__text-title">You have personal studio in your hands. Mix up and create your own songs!</strong>
                  <p class="main-board__text-desc">Social Music Service based on<br>
                    BLOCKCHAIN TECHNOLOGY</p>
                </div>
                <div class="main-board__image"><img src="/mw/eng/assets/img/img-main-board2.jpg" alt="" class="main-board__image-bg"></div>
              </div>
              <!-- swiper-slide//end -->
              <div class="swiper-slide">
                <div class="main-board__text">
                  <strong class="main-board__text-title">Share your music! People all around the world will applause and encourage you.</strong>
                  <p class="main-board__text-desc">Social Music Service based on<br>
                    BLOCKCHAIN TECHNOLOGY</p>
                </div>
                <div class="main-board__image"><img src="/mw/eng/assets/img/img-main-board3.jpg" alt="" class="main-board__image-bg"></div>
              </div>
              <!-- swiper-slide//end -->
              <div class="swiper-slide">
                <div class="main-board__text">
                  <strong class="main-board__text-title">You will be popular with your music in demand, and the profit and recognition will naturally follow. </strong>
                  <p class="main-board__text-desc">Social Music Service based on<br>
                    BLOCKCHAIN TECHNOLOGY</p>
                </div>
                <div class="main-board__image"><img src="/mw/eng/assets/img/img-main-board4.jpg" alt="" class="main-board__image-bg"></div>
              </div>
              <!-- swiper-slide//end -->
            </div>
            <!-- swiper-wrapper//end -->
          ...
          <div class="main-board__nav">
            <a href="#none" class="main-board__nav-btn main-board__nav-btn-scroll js-btn-scroll-main">Scroll Down</a>
          </div>
        </article>
        <!-- 20181027 : [E] -->
        ...
        <article class="main-alliance js-scroll-item">
          <div class="alliance-container">
            ...
            <div class="alliance-info">
              <div class="alliance-info__thumbnail"><img src="/mw/eng/assets/img/img-main-alliance.png" alt="SOMESING, as one of the official DApps on ICON, is making a significant contribution to the birth of a whole new era of blockchain." class="alliance-info__thumbnail-image"></div>
            </div>
            <!-- alliance-info//end -->
          </div>
            ...
            <div class="about-service">
              ...
              <div class="about-bg">
                <div class="about-bg__image">
                  <div class="about-bg__thumbnail"><img src="/mw/eng/assets/img/bg-about-service.png" alt="" class="about-bg__thumbnail-image"></div>
                </div>
              </div>
              ...
              <div class="about-video">
                ...
                <a href="#popup-main-video" class="about-video__anchor js-popup-open js-video-data" data-youtube-src="//www.youtube.com/embed/W5QMuJORwwQ?autoplay=1&autohide=1?rel=0&vq=hd1080">
                  <div class="about-video__image">
                    <div class="about-video__thumbnail"><img src="/mw/eng/assets/img/img-about-video.jpg" class="about-video__thumbnail-img" alt=""></div>
                  </div>
                </a>
                <!-- 동영상 있을 경우 : E -->
                <!-- 동영상 없을 경우 : S
        ...
        <article class="main-system js-scroll-item">
          <div class="system-container">
            <div class="system-header">
              ...
              <p class="system-header__desc">Each stakeholder voluntarily enters SOMESING’s ecosystem to serve themselves participating in making profits, and the ecosystem grows by those entrants and participants based on their growth of activities, which create the overall virtuous cycle in the ecosystem</p><!-- 20181027 -->
            </div>
            <!-- system-header//end -->
            <div class="system-step">
              <div class="system-step__thumbnail"><img src="/mw/eng/assets/img/img-main-system.png" alt="SOMESING Ecosystem Step - Pratner, User Pay Free User Get 70%, SOMESING + ACCOMPANIMENTGet 30%, Invester, Virtuous circle of SOMESING Ecosystem" class="system-step__thumbnail-image"></div>
            </div>
            <!-- system-step//end -->
          </div>
        ...
        <article class="main-flow js-scroll-item">
          <div class="flow-conatiner">
            <div class="flow-header">
              ...
              <p class="flow-header__desc">The ecosystem of SOMESING is designed in a way that the SingLovers receive their fair share of profit based on our effort of designing the promotions and events. (e.g. Fans’ gifts, supports, and other various collaborations of communities and events)</p><!-- 20181027 -->
            </div>
            <!-- flow-header//end -->
            <div class="flow-step">
              <div class="flow-step__image">
                <div class="flow-step__thumbnail"><img src="/mw/eng/assets/img/img-main-flow.png" alt="User & Service Step" class="flow-step__thumbnail-image"></div>
              </div>
            </div>
            <!-- flow-step//end -->
          </div>
        ...
        <article class="main-team js-scroll-item">
          <div class="team-header">
            ...
            <p class="team-header__desc">We're a team of experts and specialists creating the very first Karaoke service empowered by blockchain technology.</p>
          </div>
          <!-- team-header//end -->
            ...
            <div class="team-list">
              <ul class="team-list__itembox">
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-kjl.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-da.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-hwc.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-jwl.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">s
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-smk.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-dcs.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-fjsw.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-jk.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-ckl.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
                ...
                <li class="team-list__item">
                  <div class="team-list__image">
                    <div class="team-list__thumbnail"><img src="/mw/eng/assets/img/img-team-advisor-list-mky.jpg" alt="" class="team-list__thumbnail-image"></div>
                  </div>
                  <!-- team-list__image//end -->
                  <div class="team-list__caption">
              ...
              <ul class="partners-list__itembox">
                <li class="partners-list__item">
                  <a href="#none" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-ic.png" alt="ICON" class="partners-list__thumbnail-image"></div>
                    </div>
                ...
                <li class="partners-list__item">
                  <a href="http://www.ziller.co.kr" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-tj.png" alt="TJ communication" class="partners-list__thumbnail-image"></div>
                    </div>
                    <div class="partners-list__caption">
                      <div class="partners-list__caption-inner">
                ...
                <li class="partners-list__item">
                  <a href="https://www.skelterlabs.com" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-st.png" alt="SkelterLabs" class="partners-list__thumbnail-image"></div>
                    </div>
                    <div class="partners-list__caption">
                      <div class="partners-list__caption-inner">
                ...
                <li class="partners-list__item">
                  <a href="https://www.makestar.co" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-mk.png" alt="MAKESTAR" class="partners-list__thumbnail-image"></div>
                    </div>
                    <div class="partners-list__caption">
                      <div class="partners-list__caption-inner">
                ...
                <li class="partners-list__item">
                  <a href="https://useinsider.com" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-in.png" alt="Insider" class="partners-list__thumbnail-image"></div>
                    </div>
                    <div class="partners-list__caption">
                      <div class="partners-list__caption-inner">
                ...
                <li class="partners-list__item">
                  <a href="https://www.keypair.co.kr" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-kp.png" alt="Keypair" class="partners-list__thumbnail-image"></div>
                    </div>
                    <div class="partners-list__caption">
                      <div class="partners-list__caption-inner">
                ...
                <li class="partners-list__item">
                  <a href="http://www.emforce.co.kr" class="partners-list__anchor" target="_blank">
                    <div class="partners-list__image">
                      <div class="partners-list__thumbnail"><img src="/mw/eng/assets/img/img-partners-logo-em.png" alt="eMFORCE" class="partners-list__thumbnail-image"></div>
                    </div>
                    <div class="partners-list__caption">
                      <div class="partners-list__caption-inner">
     ...
     <!-- footer-contact//end -->
       <div class="footer-copy">
           <div class="footer-copy__header">
               <h3 class="footer-copy__heading"><img src="/mw/eng/assets/img/ico-logo-fff.png" alt="somesing"></h3>
