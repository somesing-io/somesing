          ...
          <article class="sign-notice container--wide-col">
            ...
            <div class="col-middle">
              <div class="sign-notice__header">
                ...
                <p class="sign-notice__header-desc sign-notice__header-desc-highlight1">이메일 발송이 완료되었습니다!</p>
                <p class="sign-notice__header-desc">비밀번호 재설정을 완료하시려면, 이메일 수신함을 확인하세요.</p>
              </div>
